...
;      readadc UV_SEN,       uv_reading	
      ...
      sertxd ("T= ",#temp_reading, "H= ", #humidity_reading, 13,10)  ' output reading for easy testing
...
UploadData:
   ...
   sertxd ("Reading,Temp, Humidity", 13,10)
   ...
   do
      gosub ReadEEPROM
      i = i + 2
      sertxd (#n, ",", #temp_reading, ",", #humidity_reading, 13,10)
...
'---------------------------------------------------------
WriteEEPROM:
   hi2cout i, (temp_reading, humidity_reading)	
...
'---------------------------------------------------------
ReadEEPROM:
	hi2cin i, (temp_reading, humidity_reading)
return
