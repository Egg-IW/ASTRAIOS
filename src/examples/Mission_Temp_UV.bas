...
'
' Reads a temperature sensor on B.1 input, a UV sensor on B.2 every 1  
...
;      readadc HUMIDITY_SEN, humidity_reading
      ...
      sertxd ("T= ",#temp_reading, "U= ", #uv_reading, 13,10)  ' output reading for easy testing
...
UploadData:
   ...
   do
      gosub ReadEEPROM
      i = i + 2
      sertxd (#n, ",", #temp_reading, ",", #uv_reading, 13,10)
...
'---------------------------------------------------------
' Arguments:  i, temp_reading, uv_reading
'---------------------------------------------------------
WriteEEPROM:
   hi2cout i, (temp_reading, uv_reading)	
...
'---------------------------------------------------------
ReadEEPROM:
	hi2cin i, (temp_reading, uv_reading)
return
