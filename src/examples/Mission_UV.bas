...
'
' Reads a single UV sensor on B.2 input, every 1 second, writes 
' to 32K EEPROM.
'
...
;      readadc HUMIDITY_SEN, humidity_reading
      ...
      sertxd (#uv_reading, 13,10)  ' output reading for easy testing
...
'---------------------------------------------------------
' Arguments:  i, uv_reading
'---------------------------------------------------------
WriteEEPROM:
   hi2cout i, (uv_reading)	
