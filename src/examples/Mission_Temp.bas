...
'
' Reads a single temperature sensor on B.1 input, every 1 second, writes 
' to 32K EEPROM.
'
...
;      readadc HUMIDITY_SEN, humidity_reading
      ...
      sertxd (#temp_reading, 13,10)  ' output reading for easy testing
...
'---------------------------------------------------------
' Arguments:  i, temp_reading
'---------------------------------------------------------
WriteEEPROM:
   hi2cout i, (temp_reading)	
